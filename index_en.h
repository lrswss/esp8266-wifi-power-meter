...
<table style="min-width:340px">
	<tr><th>Total revolutions:</th><td><span id="TotalRevolutions">--</span></td></tr>
	...
	<tr id="tr3"><th>Threshold value:</th><td><span id="Threshold">--</span></td></tr>
    <tr id="tr4"><th>Min./Max. readings:</th><td><span id="Min">--</span>/<span id="Max">--</span></td></tr>
	<tr><th>Runtime:</th><td><span id="Run">--d --h --m</span></td></tr>
</table>
</div>
<div id="buttons" style="margin-top:5px">
<p><button onclick="resetCounter()">Reset Counter</button><p>
<p id="p2"><button id="b2" onclick="readThreshold()">Calculate Threshold</button><p>
